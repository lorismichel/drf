...
unhealthy_thresholds = c(9.5, 76, 101, 0.071, 35.5, 155) #threshold value for "Unhealthy for sensitive groups"
moderate_thresholds = c(4.5, 36, 54, 0.055, 12.1, 55) #threshold value for "Moderate"
names(moderate_thresholds) = c('CO', 'SO2', 'NO2', 'O3', 'PM2.5', 'PM10')
names(unhealthy_thresholds) = c('CO', 'SO2', 'NO2', 'O3', 'PM2.5', 'PM10')
...
library(con2aqi)
con2aqi(pollutant="co",con=9.5,type="8h")
