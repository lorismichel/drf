...
# load the data
d <- loadMTRdata(path = "../../data/mtr-datasets/downloaded_data/", dataset.name = "air2")
...
# save results
save(d, res_pinball, selected.k, selected.sigma, file = ".../../data/mtr-datasets/computed_data/air2.Rdata")
