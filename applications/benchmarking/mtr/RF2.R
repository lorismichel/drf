...
res_pinball <- runRandomPinballAnalysis(param.knn = selected.k, param.gauss = selected.sigma, k = 2,
                                        X=d$X, Y=d$Y, X.knn = d$X.gauss, X.gauss = d$X.gauss, num_features = 100, nb_random_directions = 100)
...
save(d, res_pinball, selected.k, selected.sigma, file = "./experiments/mtr/data/RF2.Rdata")