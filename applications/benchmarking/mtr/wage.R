...
# load the data
d <- loadMTRdata(path = "../../data/mtr-datasets/downloaded_data/", dataset.name = "wage")
...
# save results
save(d, res_pinball, selected.k, selected.sigma, file = "../../data/mtr-datasets/computed_data/wage.Rdata")
