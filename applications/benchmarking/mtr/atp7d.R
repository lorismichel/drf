...
# load the data
d <- loadMTRdata(path = "../../data/mtr-datasets/downloaded_data/", dataset.name = "atp7d")
...
# save results
save(d, res_pinball, selected.k, selected.sigma, file = "../../data/mtr-datasets/computed_data/atp7d.Rdata")
